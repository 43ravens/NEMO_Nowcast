...
class TestBuildParser:
    ...
    def test_default_add_help(self):
        ...
        cli.build_parser()
        assert isinstance(
            cli.parser._optionals._actions[0], argparse._HelpAction)
...
class TestAddDateOption:
    ...
    def test_help(self):
        ...
        cli.build_parser()
        cli.add_date_option(
            '--test-date', arrow.get('2016-09-22'), 'Help message.')
        expected = (
            'Help message. Use YYYY-MM-DD format. Defaults to 2016-09-22.')
